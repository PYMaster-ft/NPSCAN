<html>
<body>
<h1 align="center">NPSCAN SCANNER</h1>
<p align="center"> 
  <a title="Version 17.0.0" href="https://github.com/cham2003/NPSCAN/releases">
     <img src="https://img.shields.io/badge/V%207.0.1-Stable-blue.svg">
  </a>
  <a title="No issue known"href="https://github.com/cham2003/NPSCAN/issues">
    <img src="https://img.shields.io/badge/Issues-None-brightgreen.svg">
  </a>
  <a title="MIT License" href="https://github.com/cham2003/NPSCAN/blob/master/License.txt">
  ...
  <a title="Follow us in Facebook" href="https://www.facebook.com/neoprogrammers/">
...
<table border="0" cellpadding="2" cellspacing="2" width="100%">
  <tr>
    <td align="center"><img title="Legal desclaimer" src="https://imgur.com/7OzJEBI.png"></td>
     <td align="center"> <b><a href="https://github.com/cham2003/">NEO PROGRAMMERS</a> is not responsible for any misuse, damage caused by this script or attacking targets without prior mutual consent! It is your responsibility to obey laws!</b>
    </td>
  </tr>
</table>
<table border="0" cellpadding="0" cellspacing="2" width="100%">
  ...
  <tr>
    <td width="100px" class="main2"><b>AUTHOR:</b></td><td width="780px">Chamindu pushpika</td>
  </tr>
  <tr>
    <td width="100px" class="main2"><b>GROUP:</b></td><td width="780px">neo@programmers</td>
  </tr>
</table>
...
<table border="0" cellpadding="2" cellspacing="5" width="100%">
  ...
  <tr>
    <td class="main">
      &#x25cf; git clone https://github.com/cham2003/NPSCAN <br/>
      &#x25cf; direct link: https://github.com/cham2003/NPSCAN
    </td>
  </tr>
</table>
<table border="0" cellpadding="2" cellspacing="5" width="100%">
...
<table border="0" cellpadding="2" cellspacing="5" width="100%">
  ...
  <tr>
    <td class="main">
      Portable Execution: perl ./npscan.pl<br/>
      Installed Tool Execution: npscan<br/>
      Menu: Applications >  Web Application analysis > npscan </td>
  </tr>
</table>
<table border="0" cellpadding="2" cellspacing="5" width="100%">
  <tr>
  ...
  <tr>
    <td class="main">
      <table border="0" cellpadding="2" cellspacing="5" width="100%"><tr><td>  
        ...
        <hr>
       &#x25cf; <b>SET HEADERS:</b> <br>
       npscan --dork [dork / dorks.txt] --level [level] --header "Authorization => 'Basic YWRtaW46YWRtaW4', keep_alive => '1'" <br/>
       npscan -t target --data "name=>username, email=>xxxxxx, pass=>xxxxx" --post --header "Authorization => 'Basic YWRtaW46YWRtaW4', keep_alive => '1'" <br/>
        <hr>
      &#x25cf; <b>SEARCH ENGINE: </b> <br/>
       Search: npscan --dork [dork] --level [level]  <br/>
	   Search: npscan -d [dork] -l [level] --getlinks <br/>
       Set engine: npscan --dork [dork] --level [level] -m bing or google,ask,yandex or all <br/>
       Set selective engines: npscan -d [dork] -l [level] -m google,bing,.. <br/>
       Search with many dorks: npscan --dork dork1 [OTHER]dork2 [OTHER]dork3] --level [level]    <br/>
       Get Server wordpress sites: npscan -t [target] --wp <br/>
       Search + output: npscan --dork [dorks.txt] --level [level] --save <br/>
       Search + get emails: npscan -d [dorks.txt] -l [level] --email  <br/>
       Search + get site emails: npscan --dork site:site.com --level [level] --email  <br/>
       Search + get ips: npscan --dork [dork] --level [level] --ips  <br/>
        <hr>
       &#x25cf; <b>REGULAR EXPRESSIONS: </b> <br/>
       Regex use: npscan [--dork [dork> / -t [target]] --level [level] --regex [regex] <br/>
       ...
       E-mails: '((([A-Za-z0-9]+_+)|([A-Za-z0-9]+\-+)|([A-Za-z0-9]+\.+)|([A-Za-z0-9]+\++))*[A-Za-z0-9]+@((\w+\-+)|(\w+\.))*\w{1,63}\.[a-zA-Z]{2,6})' <br/>
        <hr>
       &#x25cf; <b>REPEATER:</b> <br/>
       npscan -t site.com?index.php?id=rang(1-10) --sql <br/>
       npscan -t [target] --expHost "/index.php?id=rang(1-10)" --sql <br/>
       npscan -t [target] --expHost "/index.php?id=repeat(../-9)wp-config.php" <br/>
        <hr>
       &#x25cf; <b>PORTS</b> <br/>
       npscan -t [ip] --port [port] [--udp / --tcp] <br/>
       npscan -t (ip start)-(ip end) --port [port] [--udp / --tcp] <br/>
       npscan -t [ip] --port (port start)-(port end) [--udp / --tcp] --command "your extern command" <br/>
        <hr>
       ...
       Decode base64: --decode64 [string] <br/>
        <hr>
       &#x25cf; <b>DATA:</b> <br/>
       Data: npscan -t [target] --data "field1=>value1, field2=>value2, field3=>value3" [--post / --get /]<br/>
       ...
       npscan --dork [dork / dorks.txt] --level [level] --command "curl -v --TARGET" <br/>
       npscan --dork [dork / dorks.txt] --level [level] --command "file" <br/>
       npscan --dork [dork / dorks.txt] --level [level] --command "curl -v --HOST"  <br/>
       npscan --dork [dork / dorks.txt] --level [level] --command "nmap -sV -p 21,22,80 --HOSTIP"  <br/>
       npscan -d "index of /lib/scripts/dl-skin.php" -l 2 -m bing --command "php WP-dl-skin.php-exploit.php --TARGET" <br/>
       npscan --shodan --search [string] --apikey [API KEY] -command [extern_command]<br/>
        <hr>
       &#x25cf; <b>MULTIPLE SCANS: </b><br/>
       npscan --dork [dork> --level [10] --sql --lfi --wp ..<br/>
       npscan --dork [dork> --level [10] --replace [string => new_string] --exp/expHost [payload] [--sql / --lfi / --wp /...]<br/>
       npscan -t [ip] --level [10] [--sql / --lfi / --wp /...]<br/>
       npscan -t [target] [--sql / --lfi / --wp /...] <br/>
        <hr>
       &#x25cf; <b>IP LOCALISATION: </b><br/>
       npscan -t [ip/target] --geoloc <br/>
        <hr>
       &#x25cf; <b>SEARCH VALIDATION: </b><br/>
       npscan -d [dork / dorks.txt] -l [level] --status [code] / --valid [string/file] <br/>
       npscan -d [dork / dorks.txt] -l [level] --status [code] / --valid [string/file] <br/>
       npscan -d [dork / dorks.txt] -l [level] --status [code] / --exclude [string/file] <br/>
       npscan -d [dork / dorks.txt] -l [level] --ifinurl [string] <br/>
       npscan -d [dork / dorks.txt] -l [level] --sregex [regex] --valid [string] <br/>
       npscan -d [dork / dorks.txt] -l [level] --regex [regex] --valid [string] <br/>
       npscan -d [dork / dorks.txt] -l [level] --unique  <br/>
       npscan -t [target / targets.txt] [--status [code] / --valid [string] <br/>
       npscan -t [target / targets.txt] --vshell [file path] <br/>
       npscan -d [dork / dorks.txt] -l [level] --exp/expHost [payload] --status [code] / --valid [string] <br/>
       npscan -d [dorks.txt] -l [level] --replace [string => new_string] --status [code] / --valid [string] <br/>
       npscan -d [dork / dorks.txt] -l [level] [--admin / --sql ..] --status [code] / --valid [string] <br/>  
       npscan -d [dorks.txt] -l [level] --replace [string => new_string] --status [code] / --valid [string] <br/>
       npscan -d [dorks.txt] -l [level] --replaceFROM [string => new_string] --status [code] / --valid [string] <br/>
       npscan -d [dorks.txt] -l [level] --replace [string => new_string] --exp/expHost [payload] --status [code] / --valid [string] <br/>
       npscan -d [dork / dorks.txt] -l [level] [--sql / --shost ..] --status [code] / --valid [string] <br/>
       npscan -t [target / targets.txt] --valid [string] --exclude [string]<br/>
        <hr>
       &#x25cf; <b>ZONE-H: </b><br/>
       npscan -t [target / targets.txt] -v [string] --zoneH "notifier => --HOST/index.php" <br/>
        <hr>
       &#x25cf; <b>SEARCH EXPLOITS: </b><br/>
       npscan --bugtraq -d [string] -l 1 EX: npscan --bugtraq -d wordpress -l 1<br/> 
       npscan --bugtraq -d file.txt -l 1<br/>
       npscan --bugtraq -d [string] -l 1--limit 10 <br/> 
        <hr>
       &#x25cf; <b>GOOGLEAPIS SEARCH</b> <br/> 
       npscan --dork [string or file] -l 1 --apikey [API KEY] --cx [ID]<br/>
       npscan --dork [string or file] -l 1 --apikey [API KEY] --cx [ID] -v [string]<br/>
       npscan --dork [string or file] -l 1 --apikey [API KEY] --cx [ID] --exp [exploit]<br/>
       npscan --dork [string or file] -l 1 --apikey [API KEY] --cx [ID] [ANY APTION]<br/>
        <hr>
       &#x25cf; <b>SHODAN SEARCH</b> <br/> 
       npscan --shodan --targget [ip or host or file] --apikey [API KEY] <br/>
       npscan --shodan --dork [string or file] --apikey [API KEY] <br/>
       npscan --shodan --dnsresolve [ip or host or file] --apikey [API KEY] <br/>
       npscan --shodan --dnsrevese [ip or host or file] --apikey [API KEY] <br/>
       npscan --shodan --count [query or file] --apikey [API KEY] <br/>
       npscan --shodan --query --apikey [API KEY] <br/>
       npscan --shodan --querysearch [query or file] --apikey [API KEY] <br/>
       npscan --shodan --querytags --apikey [API KEY] <br/>
       npscan --shodan --myip --apikey [API KEY] <br/>
       npscan --shodan --apinfo --apikey [API KEY] <br/>
       npscan --shodan --services --apikey [API KEY] <br/>
       npscan --shodan --ports --apikey [API KEY] <br/>	 
       npscan --shodan --tokens [string or file] --apikey [API KEY] <br/>	 
        <hr>
       &#x25cf; <b>UPDATE TOOL:</b> <br/> 
       npscan --update <br/>
        <hr>
       ...
       npscan --uninstall
        <hr>
       &#x25cf; <b>THANKS TO: </b><br/>     
       Isuru heshan,supun anjana,achintha,mindara and sahan team.
       </td></tr></table>     
    </td>
  </tr>
</table>  
