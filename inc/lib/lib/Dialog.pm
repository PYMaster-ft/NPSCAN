...
sub shosearchadvise {
  print $c[4]."[!]$c[10] To learn how to use search filters type \'npscan --shodan --filters\'\n";
}
...
sub sho_menu {
  ...
  print $c[4]."  [!] $c[10]To set proxy and browser random: \'npscan --help\'\n";
  print $c[4]."  [!] $c[10]About filters: npscan --shodan --apikey <apikey> --filters\n";
