...
sub update {
  ...
  if ($same eq "yes") {   
    ...
    #############################################
    print $c[10];
    system("git clone https://github.com/cham2003/NPSCAN.git $Bin/npscan_update");
    if (!-d "$Bin/npscan_update") { print "\n"; Print::dd(); exit(); }
    print $c[10]."[i] $ZT[2]..\n";
    system "cp -r $Bin/npscan_update/inc $Bin";
    if (!-d "$Bin/inc") { Print::bb(); exit(); }
    sleep(1);
  
    #############################################
    if (-d "/usr/share/doc/npscan") {
      my @f=("README.md", "License.txt");
      print $c[10]."[i] $ZT[5] License files...\n";
      for (@f) {
        system "cp -r $Bin/npscan_update/$_ /usr/share/doc/npscan/";
        if (!-e "/usr/share/doc/npscan/$_") {
          print $c[4]."$er write to /usr/share/doc/npscan/$_!\n";
        }
      }
    }
    sleep(1);
    ...
    if (-e $scriptbash) {
      if (-d $scriptCompletion) {
        ...
        if (-d "/usr/share/icons/hicolor/16x16/apps/") {
	      system "cp $Bin/npscan_update/inc/user/desktop/16x16/npscan-menu.png /usr/share/icons/hicolor/16x16/apps/";
	      if (!-e "/usr/share/icons/hicolor/16x16/apps/npscan-menu.png") { print $c[2]."$er write in /usr/share/icons/hicolor/16x16/apps/!\n"; }
	
	      system "cp $Bin/npscan_update/inc/user/desktop/22x22/npscan-menu.png /usr/share/icons/hicolor/22x22/apps/";
	      if (!-e "/usr/share/icons/hicolor/22x22/apps/npscan-menu.png") { print $c[2]."$er write in /usr/share/icons/hicolor/22x22/apps/!\n"; }
	
	      system "cp $Bin/npscan_update/inc/user/desktop/24x24/npscan-menu.png /usr/share/icons/hicolor/24x24/apps/";
	      if (!-e "/usr/share/icons/hicolor/24x24/apps/npscan-menu.png") { print $c[2]."$er write in /usr/share/icons/hicolor/24x24/apps/!\n"; }
	
	      system "cp $Bin/npscan_update/inc/user/desktop/48x48/npscan-menu.png /usr/share/icons/hicolor/48x48/apps/";
	      if (!-e "/usr/share/icons/hicolor/48x48/apps/npscan-menu.png") { print $c[2]."$er write in /usr/share/icons/hicolor/48x48/apps/!\n"; }
	
	      system "cp $Bin/npscan_update/inc/user/desktop/256x256/npscan-menu.png /usr/share/icons/hicolor/256x256/apps/";
	      if (!-e "/usr/share/icons/hicolor/256x256/apps/npscan-menu.png") { print $c[2]."$er write in /usr/share/icons/hicolor/256x256/apps/!\n"; }
     
          my @deskFiles=("/usr/share/icons/hicolor/16x16/apps/npscan-menu.png", "/usr/share/icons/hicolor/22x22/apps/npscan-menu.png", "/usr/share/icons/hicolor/24x24/apps/npscan-menu.png",
                       "/usr/share/icons/hicolor/48x48/apps/npscan-menu.png", "/usr/share/icons/hicolor/256x256/apps/npscan-menu.png");
        }
      }
    }
    sleep(1);
    ...
    ###############################################
    print $c[10]."[i] $ZT[7].. \n";
    system "rm -rf $Bin/npscan_update";
    if (-d "$Bin/npscan_update") {
      print $c[3]."$er remove $Bin/npscan_update!\n";
    }
    sleep(1);
